...
const socials = [
  {
    label: "Follow on X",
    href: "https://x.com/palmer_bre50981",
    icon: (
  ...
  {
    label: "Follow on Figma",
    href: "https://figma.com/@Brent",
    icon: (
  ...
  },
  {
    ...
    href: "https://www.linkedin.com/in/brentpalmerdesign/",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  },
  {
    ...
    href: "https://github.com/brent-palmer",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
