...
// Simple exponential damp — avoids the maath dependency
function damp(target: { value: number }, key: "value", goal: number, lambda: number, delta: number) {
  target[key] = THREE.MathUtils.damp(target[key], goal, lambda, delta);
}
...
export function Particles({
  ...
  useFrame((state, delta) => {
    ...
    damp(dofPointsMaterial.uniforms.uTransition, "value", introspect ? 1.0 : 0.0, introspect ? 0.35 : 0.2, delta);
